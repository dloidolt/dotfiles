# Generated by Powerlevel10k configuration wizard on 2024-03-19 at 22:42 CET.
# Based on romkatv/powerlevel10k/config/p10k-classic.zsh, checksum 33069.
# Wizard options: powerline, classic, unicode, dark, vertical separators, sharp heads,
...
() {
  ...
  function my_git_formatter() {
    ...
    if (( $1 )); then
      ...
      local       meta='%166F' # grey foreground
